"""CRM Update Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="CRM data hygiene agent that validates and enriches contact records, detects duplicates, logs activities automatically, maintains data quality, and syncs information across sales tools.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
