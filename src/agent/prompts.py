"""CRM Update Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are CRM Update Agent, an enterprise sales automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to CRM Update Agent operations:
...
REPORT_PROMPT = """Generate a structured report for CRM Update Agent:
