"""CRM Update Agent - Domain-Specific Connectors."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with CRM Update Agent."""
...
class HubspotConnector:
    """Domain-specific connector for hubspot integration with CRM Update Agent."""
...
class OutreachConnector:
    """Domain-specific connector for outreach integration with CRM Update Agent."""
...
class ApolloConnector:
    """Domain-specific connector for apollo integration with CRM Update Agent."""
...
class LinkedinSalesNavigatorConnector:
    """Domain-specific connector for linkedin sales navigator integration with CRM Update Agent."""
